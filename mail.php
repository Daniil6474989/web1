...
try {
  ...
  $mail->Username   = 'diniil.simonov@yandex.ru'; // Логин на почте изменил почту
  $mail->Password   = 'uatawkdnawufxqyy'; // Пароль на почте
  $mail->SMTPSecure = 'ssl';
  $mail->Port       = 465;

  $mail->setFrom('diniil.simonov@yandex.ru', 'Заявка с сайта'); // Адрес самой почты и имя отправителя

  // Получатель письма
  $mail->addAddress('stalkergoq@gmail.com');
